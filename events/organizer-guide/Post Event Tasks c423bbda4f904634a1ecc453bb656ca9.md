...
- On Divvy: open the Divvy app and go to "Transactions," then click on any "Incomplete" transactions to upload receipts.
- On your personal card: [create a reimbursement request in Abacus.](https://www.abacus.com/expenses?filter=me)

If you don’t have an Abacus account yet, email accounts@codeday.org from your @codeday.org email for an invite.

### Add Showcase Awards

Go to [showcase.codeday.org](http://showcase.codeday.org) and find your award winners’ projects. Your event’s Regional Manager will be able to add awards to each page that earned one.

### Upload Pictures

If you took any pictures at the event, please upload them to a Google drive and send the link to your CodeDay contact so we can get them on the website.

### Thank Yous

You should send a thank-you note to your venue and volunteers.
...
- Mid-Event
    - Which activities went well, and which do we want to change for next time?
